...
echo -e "#----------------------Create a rarefaction file ---------- #\n">>script_adv.sh
...
EVEN=$(cat otu_table.stats |head -16|tail -1|cut -d : -f 2|cut -d . -f 1| cut -d ' ' -f 2)
...
echo -e "alpha_diversity.py -i otu_table_even.biom -o alpha_div.txt -m chao1,observed_species,PD_whole_tree,shannon,simpson -t phylogeny.tre\n">>script_adv.sh
